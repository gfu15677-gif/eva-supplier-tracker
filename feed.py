...
# ===== 热压EVA专用 RSS 源（只抓国内）=====
RSS_URLS = [
    # 1. Google News 搜索：热压EVA相关的供应商、厂家、行业动态（仅中文）
    "https://news.google.com/rss/search?q=%E7%83%AD%E5%8E%8BEVA+%E4%BE%9B%E5%BA%94%E5%95%86+OR+%E7%83%AD%E5%8E%8BEVA+%E5%8E%82%E5%AE%B6+OR+%E7%83%AD%E5%8E%8BEVA+%E6%9D%BF%E6%9D%90+OR+EVA%E7%83%AD%E5%8E%8B%E6%9D%90%E6%96%99+%E4%BE%9B%E5%BA%94+OR+%E7%83%AD%E5%8E%8BEVA%E5%88%B6%E5%93%81+%E7%94%9F%E4%BA%A7%E5%8E%82%E5%AE%B6&hl=zh-CN&gl=CN&ceid=CN:zh-Hans",

    # 2. 社交媒体 RSSHub 搜索（抖音、B站、微博）
    "https://rsshub.app/douyin/search/热压EVA",
    "https://rsshub.app/bilibili/vsearch/热压EVA",
    "https://rsshub.app/weibo/search/热压EVA",
]
...
def should_keep_article(title, content):
    ...
    # 强相关词（必须有至少一个）
    strong_keywords = [
        "热压eva", "eva热压", "eva板材", "eva材料", "eva发泡",
        "热压成型", "eva制品", "eva厂家", "eva供应商", "eva生产",
        "热压eva板", "eva板材厂", "eva发泡板", "eva加工"
    ]
    ...
    # 额外规则：如果标题或内容中出现明显的国外公司或国外地址，也丢弃
    foreign_indicators = ["inc", "corp", "ltd", "gmbh", "s.r.l", "co.,", "usa", "japan", "korea"]
    if any(fi in text for fi in foreign_indicators):
        return False
...
def get_new_feed_items():
    # 加载已推送链接缓存（保存7天）
    cache_file = "/tmp/pushed_links_cache_eva.json"
    pushed_links = set()
    try:
